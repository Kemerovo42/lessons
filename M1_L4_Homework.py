...
def send_welcome(message):
    ...
    bot.reply_to(message, 
                 "Добро пожаловать в платежный бот Звездами!\n Пожалуйста, выберите количество Звезд для покупки:",
                 reply_markup=markup)
...
def handle_all_messages(message):
    bot.reply_to(message, "Введите /start , для продолжения использования бота")
